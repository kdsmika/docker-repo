    ...
    <div class="form-wrapper">
        ...
        <form action="add" method="post">
            <div class="form-group">
                ...
                <input type="text" class="form-control"  id="code" name="bookId"  required>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control"  id="password" name="addedOn" readonly value="<%=date  %>" required>
              </div>
